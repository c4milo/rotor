...
const datagram_group_bytes = kqueue.buffers.group_bytes(group_buffers, datagram_buffer_bytes);
...
var remote: kqueue.Remote align(@alignOf(kqueue.Remote)) = undefined;
