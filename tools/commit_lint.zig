...
pub const module_scopes = [_][]const u8{
    "core", "sim", "uring", "kqueue", "adapter", "bench", "tools",
};
...
test "every scope CLAUDE.md names passes" {
    ...
    const scopes = [_][]const u8{ "core", "sim", "uring", "kqueue", "adapter", "bench", "tools" };
...
test "a third-person subject is refused" {
    try expect_findings("feat(sim): adds the op clock\n", &.{
