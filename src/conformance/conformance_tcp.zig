...
fn accept(user_data: u64, listener: core.Descriptor, multishot: bool) Operation {
...
fn send(user_data: u64, socket: core.Descriptor, bytes: []const u8) Operation {
...
fn connected_pair(harness: *Harness, listener: *const Listener) ![2]core.Descriptor {
