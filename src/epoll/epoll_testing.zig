...
//!
//! This is `src/uring/uring_testing.zig`, copied: both Linux backends answer these with the same
//! Linux calls, and the graph has no module the two share (`epoll_address.zig` says why).
...
pub const monotonic_ns = @import("epoll_tick.zig").clock_ns;
